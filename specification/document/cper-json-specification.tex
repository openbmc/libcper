...
\hline
containmentWarning & boolean & If true, the error was not contained within the processor or memory hierarchy, and may have propagated elsewhere.\\
\hline
...
\hline
level & uint64 & The bus hierarchy level at which the error occurred.\\
\hline
processorContextCorrupt & boolean & Whether the processor context might have been corrupted.\\
\hline
uncorrected & boolean & Whether the error remained uncorrected.\\
...
\hline
privelegeModeRequested & boolean & Whether privilege mode was requested.\\
\hline
