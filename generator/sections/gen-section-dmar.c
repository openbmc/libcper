...
// Generates a single pseudo-random generic DMAr error section, saving the
...
// Generates a single pseudo-random VT-d DMAr error section, saving the
// resulting address to the given location. Returns the size of the newly
// created section.
...
// Generates a single pseudo-random IOMMU DMAr error section, saving the
// resulting address to the given location. Returns the size of the newly
// created section.
