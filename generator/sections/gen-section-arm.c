...
// Generates a single pseudo-random ARM processor section, saving the resulting
...
// Generates a single pseudo-random ARM error info structure. Must be later
// freed.
void* generate_arm_error_info()
{
...
// Generates a single pseudo-random ARM context info structure. Must be later
// freed.
size_t generate_arm_context_info(void** location)
{
