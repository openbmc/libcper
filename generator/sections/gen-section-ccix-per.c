...
// Generates a single pseudo-random CCIX PER error section, saving the resulting
...
size_t generate_section_ccix_per(void** location)
{
    ...
    // The log attached here does not necessarily conform to the CCIX
    // specification, and is simply random.
