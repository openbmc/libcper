...
json_object *pcie_capability_to_ir(EFI_PCIE_ERROR_DATA *pcie_error)
{
	...
	add_bool(fields_ir, "flit_mode_supported",
	...
	add_bool(fields_ir, "phantom_functions_supported",
		 cap_decode->device_capabilities.phantom_functions_supported);
	add_bool(fields_ir, "extended_tag_field_supported",
	...
	add_bool(fields_ir, "mixed_mps_supported",
		 cap_decode->device_capabilities.mixed_mps_supported);
	add_bool(fields_ir, "tee_io_supported",
	...
	add_bool(fields_ir, "non_fatal_error_reporting_enable",
	...
	add_bool(fields_ir, "relaxed_ordering_enable",
	...
	add_bool(fields_ir, "extended_tag_field_enable",
		 cap_decode->device_control.extended_tag_field_enable);
	add_bool(fields_ir, "phantom_functions_enable",
		 cap_decode->device_control.phantom_functions_enable);
	add_bool(fields_ir, "aux_power_pm_enable",
	...
	add_bool(fields_ir, "completion_timeout_disable_supported",
		 cap_decode->device_capabilities2
			 .completion_timeout_disable_supported);
	add_bool(fields_ir, "ari_forwarding_supported",
		 cap_decode->device_capabilities2.ari_forwarding_supported);
	add_bool(fields_ir, "atomic_op_routing_supported",
		 cap_decode->device_capabilities2.atomic_op_routing_supported);
	add_bool(fields_ir, "_32_bit_atomicop_completer_supported",
		 cap_decode->device_capabilities2
			 ._32_bit_atomicop_completer_supported);
	add_bool(fields_ir, "_64_bit_atomicop_completer_supported",
		 cap_decode->device_capabilities2
			 ._64_bit_atomicop_completer_supported);
	add_bool(fields_ir, "_128_bit_cas_completer_supported",
		 cap_decode->device_capabilities2
			 ._128_bit_cas_completer_supported);
	add_bool(fields_ir, "no_ro_enabled_pr_pr_passing",
		 cap_decode->device_capabilities2.no_ro_enabled_pr_pr_passing);
	add_bool(fields_ir, "ltr_mechanism_supported",
		 cap_decode->device_capabilities2.ltr_mechanism_supported);
	add_bool(fields_ir, "tph_completer_supported",
	...
	add_bool(fields_ir, "obff_supported",
	...
	add_dict(fields_ir, "max_end_end_tlp_prefixes",
		 ...
		 NULL, 0);
	add_bool(fields_ir, "emergency_power_reduction_supported",
		 cap_decode->device_capabilities2
	...
	add_bool(fields_ir, "crosslink_supported",
	...
	add_bool(fields_ir, "retimer_presence_detect_supported",
		 cap_decode->link_capabilities2
			 .retimer_presence_detect_supported);
	add_bool(fields_ir, "two_retimers_presence_detect_supported",
		 cap_decode->link_capabilities2
			 .two_retimers_presence_detect_supported);
	//add_int(fields_ir, "reserved", cap_decode->link_capabilities2.reserved);
	add_bool(fields_ir, "drs_supported",
	...
	add_bool(fields_ir, "enter_compliance",
...
json_object *pcie_aer_to_ir(EFI_PCIE_ERROR_DATA *pcie_error)
{
	...
	add_bool(fields_ir, "data_link_protocol_error_severity",
		 aer_decode->uncorrectable_error_severity
			 .data_link_protocol_error_severity);
	add_bool(fields_ir, "surprise_down_error_severity",
		 aer_decode->uncorrectable_error_severity
			 .surprise_down_error_severity);
	//add_int(fields_ir, "rsvdz2",
	//	aer_decode->uncorrectable_error_severity.rsvdz2);
	add_bool(fields_ir, "poisoned_tlp_received_severity",
		 aer_decode->uncorrectable_error_severity
			 .poisoned_tlp_received_severity);
	add_bool(fields_ir, "flow_control_protocol_error_severity",
		 aer_decode->uncorrectable_error_severity
			 .flow_control_protocol_error_severity);
	add_bool(fields_ir, "completion_timeout_severity",
		 aer_decode->uncorrectable_error_severity
			 .completion_timeout_severity);
	add_bool(fields_ir, "completer_abort_severity",
		 aer_decode->uncorrectable_error_severity
			 .completer_abort_severity);
	add_bool(fields_ir, "unexpected_completion_severity",
		 aer_decode->uncorrectable_error_severity
			 .unexpected_completion_severity);
	add_bool(fields_ir, "receiver_overflow_severity",
		 aer_decode->uncorrectable_error_severity
			 .receiver_overflow_severity);
	add_bool(
		fields_ir, "malformed_tlp_severity",
		aer_decode->uncorrectable_error_severity.malformed_tlp_severity);
	add_bool(fields_ir, "ecrc_error_severity",
		 aer_decode->uncorrectable_error_severity.ecrc_error_severity);
	add_bool(fields_ir, "unsupported_request_error_severity",
		 aer_decode->uncorrectable_error_severity
			 .unsupported_request_error_severity);
	add_bool(
		fields_ir, "acs_violation_severity",
		aer_decode->uncorrectable_error_severity.acs_violation_severity);
	add_bool(fields_ir, "uncorrectable_internal_error_severity",
		 aer_decode->uncorrectable_error_severity
			 .uncorrectable_internal_error_severity);
	add_bool(fields_ir, "mc_blocked_tlp_severity",
		 aer_decode->uncorrectable_error_severity
			 .mc_blocked_tlp_severity);
	add_bool(fields_ir, "atomicop_egress_blocked_severity",
		 aer_decode->uncorrectable_error_severity
			 .atomicop_egress_blocked_severity);
	add_bool(fields_ir, "tlp_prefix_blocked_error_severity",
		 aer_decode->uncorrectable_error_severity
			 .tlp_prefix_blocked_error_severity);
	add_bool(fields_ir, "poisoned_tlp_egress_blocked_severity",
		 aer_decode->uncorrectable_error_severity
			 .poisoned_tlp_egress_blocked_severity);
	add_bool(fields_ir, "dmwr_request_egress_blocked_severity",
		 aer_decode->uncorrectable_error_severity
			 .dmwr_request_egress_blocked_severity);
	add_bool(fields_ir, "ide_check_failed_severity",
		 aer_decode->uncorrectable_error_severity
			 .ide_check_failed_severity);
	add_bool(fields_ir, "misrouted_ide_tlp_severity",
		 aer_decode->uncorrectable_error_severity
			 .misrouted_ide_tlp_severity);
	add_bool(fields_ir, "pcrc_check_failed_severity",
		 aer_decode->uncorrectable_error_severity
			 .pcrc_check_failed_severity);
	add_bool(fields_ir, "tlp_translation_egress_blocked_severity",
		 aer_decode->uncorrectable_error_severity
	 ...
	 */
	fields_ir = json_object_new_object();
	add_bool(fields_ir, "receiver_error_masked",
		 aer_decode->correctable_error_mask.receiver_error_masked);
	//add_int(fields_ir, "rsvdz1", aer_decode->correctable_error_mask.rsvdz1);
	add_bool(fields_ir, "bad_tlp_masked",
		 aer_decode->correctable_error_mask.bad_tlp_masked);
	add_bool(fields_ir, "bad_dllp_masked",
		 aer_decode->correctable_error_mask.bad_dllp_masked);
	add_bool(fields_ir, "replay_num_rollover_masked",
		 aer_decode->correctable_error_mask.replay_num_rollover_masked);
	//add_int(fields_ir, "rsvdz2", aer_decode->correctable_error_mask.rsvdz2);
	add_bool(
		fields_ir, "replay_timer_timeout_masked",
		aer_decode->correctable_error_mask.replay_timer_timeout_masked);
	add_bool(fields_ir, "advisory_non_fatal_error_masked",
		 aer_decode->correctable_error_mask
			 .advisory_non_fatal_error_masked);
	add_bool(fields_ir, "corrected_internal_error_masked",
		 aer_decode->correctable_error_mask
			 .corrected_internal_error_masked);
	add_bool(fields_ir, "header_log_overflow_masked",
		 aer_decode->correctable_error_mask.header_log_overflow_masked);
