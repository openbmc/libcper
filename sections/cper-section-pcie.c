...
void add_json_field_bool(json_object *register_ir, const char *field_name, UINT64 value) {
	json_object_object_add(register_ir, field_name, json_object_new_boolean(value));
}
...
struct aer_info_registers {
	...
	advanced_error_capabilities_and_control_t advanced_error_capabilities_and_control;
	UINT32 tlp_header0;
	UINT32 tlp_header1;
	UINT32 tlp_header2;
	UINT32 tlp_header3;
...
json_object *pcie_capability_to_ir(EFI_PCIE_ERROR_DATA *pcie_error)
{
	 ...
	 */
	register_fields_ir = json_object_new_object();
	JSON_FIELD_INT(register_fields_ir, current_de_emphasis_level,
...
json_object *pcie_aer_to_ir(EFI_PCIE_ERROR_DATA *pcie_error)
{
	...
	JSON_FIELD_INT(register_fields_ir, capability_version,
		       aer_decode->capability_header);
	JSON_FIELD_INT(register_fields_ir, next_capability_offset,
		       aer_decode->capability_header);
	json_object_object_add(aer_capability_ir, "capability_header", register_fields_ir);
	...
	JSON_FIELD_INT(register_fields_ir, rsvdz1,
		       aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
			data_link_protocol_error_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, surprise_down_error_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_INT(register_fields_ir, rsvdz2,
		       aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, poisoned_tlp_received,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
			flow_control_protocol_error_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, completion_timeout_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, completer_abort_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, unexpected_completion_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, receiver_overflow_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, malformed_tlp_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_error_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
			unsupported_request_error_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, acs_violation_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
			uncorrectable_internal_error_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, mc_blocked_tlp_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, ide_check_failed_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, misrouted_ide_tlp_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, pcrc_check_failed_status,
			aer_decode->uncorrectable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
			tlp_translation_egress_blocked_status,
			aer_decode->uncorrectable_error_status);
	json_object_object_add(aer_capability_ir, "uncorrectable_error_status", register_fields_ir);
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, surprise_down_error_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_INT(register_fields_ir, rsvdz2,
		       aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, poisoned_tlp_received_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir,
			flow_control_protocol_error_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, completion_timeout_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, completer_abort_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, unexpected_completion_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, receiver_overflow_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, malformed_tlp_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_error_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir,
			unsupported_request_error_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, acs_violation_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir,
			uncorrectable_internal_error_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, mc_blocked_tlp_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, atomicop_egress_blocked_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, ide_check_failed_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, misrouted_ide_tlp_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, pcrc_check_failed_mask,
			aer_decode->uncorrectable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir,
			tlp_translation_egress_blocked_mask,
			aer_decode->uncorrectable_error_mask);
	json_object_object_add(aer_capability_ir, "uncorrectable_error_mask", register_fields_ir);
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, surprise_down_error_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_INT(register_fields_ir, rsvdz2,
		       aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, completion_timeout_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, completer_abort_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir,
			unexpected_completion_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, receiver_overflow_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, malformed_tlp_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_error_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir,
			unsupported_request_error_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, acs_violation_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir,
			uncorrectable_internal_error_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, mc_blocked_tlp_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, ide_check_failed_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, misrouted_ide_tlp_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir, pcrc_check_failed_severity,
			aer_decode->uncorrectable_error_severity);
	JSON_FIELD_BOOL(register_fields_ir,
			tlp_translation_egress_blocked_severity,
			aer_decode->uncorrectable_error_severity);
	json_object_object_add(aer_capability_ir, "uncorrectable_error_severity", register_fields_ir);
	 ...
	 */
	register_fields_ir = json_object_new_object();
	JSON_FIELD_BOOL(register_fields_ir, receiver_error_status,
			aer_decode->correctable_error_status);
	JSON_FIELD_INT(register_fields_ir, rsvdz1,
		       aer_decode->correctable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, bad_tlp_status,
			aer_decode->correctable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, bad_dllp_status,
			aer_decode->correctable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, replay_num_rollover_status,
			aer_decode->correctable_error_status);
	JSON_FIELD_INT(register_fields_ir, rsvdz2,
		       aer_decode->correctable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, replay_timer_timeout_status,
			aer_decode->correctable_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->correctable_error_status);
	JSON_FIELD_BOOL(register_fields_ir, header_log_overflow_status,
			aer_decode->correctable_error_status);
	JSON_FIELD_INT(register_fields_ir, rsvdz3,
		       aer_decode->correctable_error_status);
	json_object_object_add(aer_capability_ir, "correctable_error_status", register_fields_ir);
	 ...
	 */
	register_fields_ir = json_object_new_object();
	JSON_FIELD_BOOL(register_fields_ir, receiver_error_mask,
			aer_decode->correctable_error_mask);
	JSON_FIELD_INT(register_fields_ir, rsvdz1,
		       aer_decode->correctable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, bad_tlp_mask,
			aer_decode->correctable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, bad_dllp_mask,
			aer_decode->correctable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, replay_num_rollover_mask,
			aer_decode->correctable_error_mask);
	JSON_FIELD_INT(register_fields_ir, rsvdz2,
		       aer_decode->correctable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, replay_timer_timeout_mask,
			aer_decode->correctable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->correctable_error_mask);
	JSON_FIELD_BOOL(register_fields_ir, header_log_overflow_mask,
			aer_decode->correctable_error_mask);
	JSON_FIELD_INT(register_fields_ir, rsvdz3,
		       aer_decode->correctable_error_mask);
	json_object_object_add(aer_capability_ir, "correctable_error_mask", register_fields_ir);
	 ...
	 */
	register_fields_ir = json_object_new_object();
	JSON_FIELD_INT(register_fields_ir, first_error_pointer,
		       aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_generation_capable,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_generation_enable,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_check_capable,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir, ecrc_check_enable,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir, tlp_prefix_log_present,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir,
			completion_timeout_prefix_header_log_capable,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_INT(register_fields_ir, header_log_size,
		       aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_BOOL(register_fields_ir, logged_tlp_was_flit_mode,
			aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_INT(register_fields_ir, logged_tlp_size,
		       aer_decode->advanced_error_capabilities_and_control);
	JSON_FIELD_INT(register_fields_ir, rsvdp,
		       aer_decode->advanced_error_capabilities_and_control);
	json_object_object_add(aer_capability_ir, "advanced_error_capabilities_and_control", register_fields_ir);
	...
	JSON_FIELD_INT(register_fields_ir, rsvdp,
		       aer_decode->root_error_command);
	json_object_object_add(aer_capability_ir, "root_error_command", register_fields_ir);
	 ...
	 */
	register_fields_ir = json_object_new_object();
	JSON_FIELD_BOOL(register_fields_ir, err_cor_received,
			aer_decode->root_error_status);
	JSON_FIELD_BOOL(register_fields_ir, multiple_err_cor_received,
			aer_decode->root_error_status);
	JSON_FIELD_BOOL(register_fields_ir, err_fatal_nonfatal_received,
			aer_decode->root_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
			multiple_err_fatal_nonfatal_received,
			aer_decode->root_error_status);
	JSON_FIELD_BOOL(register_fields_ir, first_uncorrectable_fatal,
			aer_decode->root_error_status);
	JSON_FIELD_BOOL(register_fields_ir,
	...
	JSON_FIELD_BOOL(register_fields_ir,
			...
			aer_decode->root_error_status);
	JSON_FIELD_INT(register_fields_ir, err_cor_subclass,
		       aer_decode->root_error_status);
	JSON_FIELD_INT(register_fields_ir, rsvdz,
		       aer_decode->root_error_status);
	JSON_FIELD_INT(register_fields_ir,
		       ...
		       aer_decode->root_error_status);
	json_object_object_add(aer_capability_ir, "root_error_status", register_fields_ir);
	 ...
	 */
	register_fields_ir = json_object_new_object();
	JSON_FIELD_INT(register_fields_ir, err_cor_source_identification,
		       aer_decode->error_source_id);
	JSON_FIELD_INT(register_fields_ir,
		       err_fatal_nonfatal_source_indentification,
		       aer_decode->error_source_id);
	json_object_object_add(aer_capability_ir, "error_source_id", register_fields_ir);
