...
struct link_status_2 {
	UINT32 current_deemphasis_level : 1;		 // bit [0]
	UINT32 equalization_8GTS_complete : 1;		 // bit [1]
	UINT32 equalization_8GTS_phase_1_successful : 1; // bit [2]
	UINT32 equalization_8GTS_phase_2_successful : 1; // bit [3]
	UINT32 equalization_8GTS_phase_3_successful : 1; // bit [4]
	UINT32 link_equalization_request_8GTS : 1;	 // bit [5]
	UINT32 retimer_presence_detected : 1;		 // bit [6]
	UINT32 two_retimers_presence_detected : 1;	 // bit [7]
	UINT32 crosslink_resolution : 2;		 // bits [9:8]
	UINT32 flit_mode_status : 1;			 // bit [10]
	UINT32 rsvdZ : 1;				 // bit [11]
	UINT32 downstream_complonent_presence : 3;	 // bits [14:12]
	UINT32 drs_message_received : 1;		 // bit [15]
} __attribute__((packed));
