	...
	struct type_decode_entry {
		...
		{ TYPE_MSG0,
		  { "Reserved", "Msg " TYPE_MSG0_STR, "Reserved",
		    "MsgD " TYPE_MSG0_STR, "TLP Prefix", "Reserved",
		    "Reserved", "Reserved" } },
		{ TYPE_MSG1,
		  { "Reserved", "Msg " TYPE_MSG1_STR, "Reserved",
		    "MsgD " TYPE_MSG1_STR, "TLP Prefix", "Reserved",
		    "Reserved", "Reserved" } },
		{ TYPE_MSG2,
		  { "Reserved", "Msg " TYPE_MSG2_STR, "Reserved",
		    "MsgD " TYPE_MSG2_STR, "TLP Prefix", "Reserved",
		    "Reserved", "Reserved" } },
		{ TYPE_MSG3,
		  { "Reserved", "Msg " TYPE_MSG3_STR, "Reserved",
		    "MsgD " TYPE_MSG3_STR, "TLP Prefix", "Reserved",
		    "Reserved", "Reserved" } },
		{ TYPE_MSG4,
		  { "Reserved", "Msg " TYPE_MSG4_STR, "Reserved",
		    "MsgD " TYPE_MSG4_STR, "TLP Prefix", "Reserved",
		    "Reserved", "Reserved" } },
		{ TYPE_MSG5,
		  { "Reserved", "Msg " TYPE_MSG5_STR, "Reserved",
		    "MsgD " TYPE_MSG5_STR, "TLP Prefix", "Reserved",
		    "Reserved", "Reserved" } },
	};
