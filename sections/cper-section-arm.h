...
#define ARM_ERROR_INFO_ENTRY_VALID_BITFIELD_NAMES                              \
    ...
    {                                                                          \
        "multipleErrorValid", "flagsValid", "errorInformationValid",           \
            "virtualFaultAddressValid", "physicalFaultAddressValid"            \
    }
...
#define ARM_BUS_ERROR_VALID_BITFIELD_NAMES                                     \
    ...
    {                                                                          \
        "transactionTypeValid", "operationValid", "levelValid",                \
            "processorContextCorruptValid", "correctedValid",                  \
            "precisePCValid", "restartablePCValid", "participationTypeValid",  \
            "timedOutValid", "addressSpaceValid", "memoryAttributesValid",     \
            "accessModeValid"                                                  \
    }
...
#define ARM_CACHE_BUS_OPERATION_TYPES_VALUES                                   \
    ...
    {                                                                          \
        "Generic Error", "Generic Read", "Generic Write", "Data Read",         \
            "Data Write", "Instruction Fetch", "Prefetch", "Eviction",         \
            "Snooping", "Snooped", "Management"                                \
    }
...
#define ARM_TLB_OPERATION_TYPES_VALUES                                         \
    ...
    {                                                                          \
        "Generic Error", "Generic Read", "Generic Write", "Data Read",         \
            ...
            "Local Management Operation", "External Management Operation"      \
    }
...
#define ARM_PROCESSOR_INFO_REGISTER_CONTEXT_TYPES_VALUES                       \
    (const char*[])                                                            \
    {                                                                          \
        "AArch32 General Purpose Registers", "AArch32 EL1 Context Registers",  \
            "AArch32 EL2 Context Registers",                                   \
            "AArch32 Secure Context Registers",                                \
            "AArch64 General Purpose Registers",                               \
            "AArch64 EL1 Context Registers", "AArch64 EL2 Context Registers",  \
...
#define ARM_AARCH32_GPR_NAMES                                                  \
    ...
    {                                                                          \
        "r0", "r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8", "r9", "r10",     \
            "r11", "r12", "r13_sp", "r14_lr", "r15_pc"                         \
    }
#define ARM_AARCH32_EL1_REGISTER_NAMES                                         \
    (const char*[])                                                            \
    {                                                                          \
        "dfar", "dfsr", "ifar", "isr", "mair0", "mair1", "midr", "mpidr",      \
            "nmrr", "prrr", "sctlr_ns", "spsr", "spsr_abt", "spsr_fiq",        \
            "spsr_irq", "spsr_svc", "spsr_und", "tpidrprw", "tpidruro",        \
            "tpidrurw", "ttbcr", "ttbr0", "ttbr1", "dacr"                      \
    }
#define ARM_AARCH32_EL2_REGISTER_NAMES                                         \
    (const char*[])                                                            \
    {                                                                          \
        "elr_hyp", "hamair0", "hamair1", "hcr", "hcr2", "hdfar", "hifar",      \
            "hpfar", "hsr", "htcr", "htpidr", "httbr", "spsr_hyp", "vtcr",     \
            "vttbr", "dacr32_el2"                                              \
    }
...
#define ARM_AARCH64_EL1_REGISTER_NAMES                                         \
    (const char*[])                                                            \
    {                                                                          \
        "elr_el1", "esr_el1", "far_el1", "isr_el1", "mair_el1", "midr_el1",    \
            "mpidr_el1", "sctlr_el1", "sp_el0", "sp_el1", "spsr_el1",          \
            "tcr_el1", "tpidr_el0", "tpidr_el1", "tpidrro_el0", "ttbr0_el1",   \
            "ttbr1_el1"                                                        \
    }
#define ARM_AARCH64_EL2_REGISTER_NAMES                                         \
    (const char*[])                                                            \
    {                                                                          \
        "elr_el2", "esr_el2", "far_el2", "hacr_el2", "hcr_el2", "hpfar_el2",   \
            "mair_el2", "sctlr_el2", "sp_el2", "spsr_el2", "tcr_el2",          \
            "tpidr_el2", "ttbr0_el2", "vtcr_el2", "vttbr_el2"                  \
    }
#define ARM_AARCH64_EL3_REGISTER_NAMES                                         \
    (const char*[])                                                            \
    {                                                                          \
        "elr_el3", "esr_el3", "far_el3", "mair_el3", "sctlr_el3", "sp_el3",    \
            "spsr_el3", "tcr_el3", "tpidr_el3", "ttbr0_el3"                    \
    }
