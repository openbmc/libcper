...
#define IPF_PSI_STATIC_INFO_VALID_BITFIELD_NAMES                               \
    (const char*[])                                                            \
    {                                                                          \
        "minstateValid", "brValid", "crValid", "arValid", "rrValid", "frValid" \
    }

///
/// IPF Error Record Section
/// Defined as according to B.2.3 of the ItaniumTM Processor Family System
/// Abstraction Layer (SAL) Specification.
///
typedef struct
{
...
typedef struct
{
    ...
    UINT64 ModCheckInfo;
    UINT64 ModTargetId;
    UINT64 ModRequestorId; // NOTE: The Intel Itanium specification contains a
                           // typo which makes the order
    UINT64 ModResponderId; // of these two fields undefined. This is a best
                           // guess and could be wrong.
    UINT64 ModPreciseIp;
