...
#define MEMORY_ERROR_VALID_BITFIELD_NAMES                                      \
    ...
    {                                                                          \
        "errorStatusValid", "physicalAddressValid",                            \
            ...
            "columnValid", "bitPositionValid", "platformRequestorIDValid",     \
            "platformResponderIDValid", "memoryPlatformTargetValid",           \
            "memoryErrorTypeValid", "rankNumberValid", "cardHandleValid",      \
            "moduleHandleValid", "extendedRowBitsValid", "bankGroupValid",     \
            "bankAddressValid", "chipIdentificationValid"                      \
    }
...
#define MEMORY_ERROR_TYPES_VALUES                                              \
    ...
    {                                                                          \
        "Unknown", "No Error", "Single-bit ECC", "Multi-bit ECC",              \
            ...
            "Master Abort", "Target Abort", "Parity Error",                    \
            "Watchdog Timeout", "Invalid Address", "Mirror Broken",            \
            "Memory Sparing", "Scrub Corrected Error",                         \
            "Scrub Uncorrected Error", "Physical Memory Map-out Event"         \
    }
#define MEMORY_ERROR_2_VALID_BITFIELD_NAMES                                    \
    ...
    {                                                                          \
        "errorStatusValid", "physicalAddressValid",                            \
            "physicalAddressMaskValid", "nodeValid", "cardValid",              \
            "moduleValid", "bankValid", "deviceValid", "rowValid",             \
            "columnValid", "rankValid", "bitPositionValid", "chipIDValid",     \
            "memoryErrorTypeValid", "statusValid", "requestorIDValid",         \
            "responderIDValid", "targetIDValid", "cardHandleValid",            \
