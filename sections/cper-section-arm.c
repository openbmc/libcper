			  ...
			  char **err_info_desc_i)
{
	...
	json_object *error_type = bitfield_to_ir(
		error_info->Type, 4, ARM_ERROR_INFO_ENTRY_INFO_TYPES_NAMES);
...
void ir_arm_error_info_to_cper(json_object *error_info, FILE *out)
{
	...
	//Type, multiple error.
	error_info_cper.Type = (UINT8)ir_to_bitfield(
		json_object_object_get(error_info, "errorType"), 4, ARM_ERROR_INFO_ENTRY_INFO_TYPES_NAMES);
