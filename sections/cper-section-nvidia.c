...
void ir_section_nvidia_to_cper(json_object *section, FILE *out)
{
	...
	size_t section_sz = sizeof(EFI_NVIDIA_ERROR_DATA) +
	       ...
	       section_cper->Signature[sizeof(section_cper->Signature) - 1] =
		       '\0';
	       ...
	       section_cper->Socket = json_object_get_int(
		       json_object_object_get(section, "socket"));
