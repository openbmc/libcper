...
/**
 * Extern definitions for EFI GUIDs relating to notification types and error
 *section types.
 **/
#include "Cper.h"
...
EFI_GUID gEfiEventNotificationTypeCxlGuid = {
    0x69293BC9,
    0x41DF,
    0x49A3,
...
EFI_GUID gEfiIa32X64ProcessorErrorSectionGuid = {
    ...
    0x4797,
    {0xb9, 0x5b, 0x53, 0xfa, 0x24, 0x2b, 0x6e, 0x1d}};
EFI_GUID gEfiIpfProcessorErrorSectionGuid = {
    0xe429faf1,
    0x3cb7,
    0x11d4,
...
EFI_GUID gEfiPlatformMemoryError2SectionGuid = {
    0x61EC04FC,
    0x48E6,
    0xD813,
...
EFI_GUID gEfiCcixPerLogErrorSectionGuid = {
    0x91335EF6,
    0xEBFB,
    0x4478,
    {0xA6, 0xA6, 0x88, 0xB7, 0x28, 0xCF, 0x75, 0xD7}};
EFI_GUID gEfiCxlProtocolErrorSectionGuid = {
    0x80B9EFB4,
    0x52B5,
    0x4DE3,
    {0xA7, 0x77, 0x68, 0x78, 0x4B, 0x77, 0x10, 0x48}};
EFI_GUID gEfiCxlGeneralMediaErrorSectionGuid = {
    0xfbcd0a77,
    0xc260,
    0x417f,
    {0x85, 0xa9, 0x08, 0x8b, 0x16, 0x21, 0xeb, 0xa6}};
EFI_GUID gEfiCxlDramEventErrorSectionGuid = {
    0x601dcbb3,
    0x9c06,
    0x4eab,
    {0xb8, 0xaf, 0x4e, 0x9b, 0xfb, 0x5c, 0x96, 0x24}};
EFI_GUID gEfiCxlMemoryModuleErrorSectionGuid = {
    0xfe927475,
    0xdd59,
    0x4339,
    {0xa5, 0x86, 0x79, 0xba, 0xb1, 0x13, 0xb7, 0x74}};
EFI_GUID gEfiCxlPhysicalSwitchErrorSectionGuid = {
    0x77cf9271,
    0x9c02,
    0x470b,
    {0x9f, 0xe4, 0xbc, 0x7b, 0x75, 0xf2, 0xda, 0x97}};
EFI_GUID gEfiCxlVirtualSwitchErrorSectionGuid = {
    0x40d26425,
    0x3396,
    0x4c4d,
    {0xa5, 0xda, 0x3d, 0x47, 0x26, 0x3a, 0xf4, 0x25}};
EFI_GUID gEfiCxlMldPortErrorSectionGuid = {
    0x8dc44363,
    0x0c96,
    0x4710,
    {0xb7, 0xbf, 0x04, 0xbb, 0x99, 0x53, 0x4c, 0x3f}};
...
EFI_GUID gEfiNvidiaErrorSectionGuid = {
    0x6d5244f2,
    0x2712,
    0x11ec,
