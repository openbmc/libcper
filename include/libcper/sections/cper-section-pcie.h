...
typedef struct pcie_capability_header pcie_capability_header_t;
...
typedef struct pcie_capabilities pcie_capabilities_t;
...
typedef struct device_capabilities device_capabilities_t;
...
typedef struct link_capabilities link_capabilities_t;
...
struct link_control {
	...
	UINT16 ptm_prop_delay_adaptation_interpretation_bit : 1; // bit [2]
...
typedef struct link_control link_control_t;
...
typedef struct slot_capabilities slot_capabilities_t;
...
typedef struct slot_control slot_control_t;
...
typedef struct slot_status slot_status_t;
...
typedef struct root_control root_control_t;
 ...
 * Offset: 0x1E
 */
struct root_capabilities {
	UINT16 configuraton_rrs_software_visibility : 1; // bit [0]
	UINT16 rsvdp : 15;                               // bits [15:1]
} __attribute__((packed));

typedef struct root_capabilities root_capabilities_t;
...
typedef struct root_status root_status_t;
...
typedef struct device_capabilities2 device_capabilities2_t;
...
typedef struct device_control2 device_control2_t;
 ...
 * Offset: 0x2A
 */
struct device_status2 {
	UINT16 rsvdz : 16;                     // bits [15:0]
} __attribute__((packed));

typedef struct device_status2 device_status2_t;
 ...
 * Offset: 0x2C
 */
struct link_capabilities2 {
	UINT32 rsvdp : 1;                                  // bit [0]
	UINT32 supported_link_speeds : 7;                  // bits [7:1]
...
typedef struct link_capabilities2 link_capabilities2_t;
...
typedef struct link_control2 link_control2_t;
...
typedef struct link_status2 link_status2_t;
 ...
 * Offset: 0x34
 */
struct slot_capabilities2 {
	UINT32 rsvdp : 32; // bits [31:0]
} __attribute__((packed));

typedef struct slot_capabilities2 slot_capabilities2_t;
 ...
 * Offset: 0x38
 */
struct slot_control2 {
	UINT16 rsvdp : 16; // bits [15:0]
} __attribute__((packed));

typedef struct slot_control2 slot_control2_t;
...
typedef struct capability_header capability_header_t;
 ...
 * Offset: 0x4
 */
struct uncorrectable_error_status {
...
typedef struct uncorrectable_error_status uncorrectable_error_status_t;
 ...
 * Offset: 0x8
 */
struct uncorrectable_error_mask {
	UINT32 undefined : 1;                           // bits [0]
	UINT32 rsvdz1 : 3;                              // bits [3:1]
...
typedef struct uncorrectable_error_mask uncorrectable_error_mask_t;
 ...
 * Offset: 0xC
 */
struct uncorrectable_error_severity {
	UINT32 undefined : 1;                               // bits [0]
	UINT32 rsvdz1 : 3;                                  // bits [3:1]
...
typedef struct uncorrectable_error_severity uncorrectable_error_severity_t;
 ...
 * Offset: 0x10
 */
struct correctable_error_status {
...
typedef struct correctable_error_status correctable_error_status_t;
...
typedef struct correctable_error_mask correctable_error_mask_t;
 ...
 * Offset: 0x18
 */
struct advanced_error_capabilities_and_control {
...
typedef struct advanced_error_capabilities_and_control advanced_error_capabilities_and_control_t;
...
typedef struct root_error_command root_error_command_t;
...
typedef struct root_error_status root_error_status_t;
 ...
 * Offset: 0x34
 */
struct error_source_id {
	UINT32 err_cor_source_identification : 16;             // bits [15:0]
	UINT32 err_fatal_nonfatal_source_indentification : 16; // bits [31:16]
} __attribute__((packed));

typedef struct error_source_id error_source_id_t;

/*
 * End Of AER Registers
 */


typedef struct slot_status2 slot_status2_t;
#ifdef __cplusplus
}
#endif
