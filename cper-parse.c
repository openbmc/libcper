...
cper_section_descriptor_to_ir(EFI_ERROR_SECTION_DESCRIPTOR *section_descriptor)
{
	...
	add_uint(section_descriptor_ir, "sectionOffset", section_descriptor->SectionOffset);
	add_uint(section_descriptor_ir, "sectionLength", section_descriptor->SectionLength);
