...
#define CPER_EXAMPLE_SECTIONS                                                  \
	"arm", "arm-ras", "ccixper", "cxlcomponent-media", "cxlprotocol",      \
		"dmargeneric", "dmariommu", "dmarvtd", "firmware", "generic",  \
		"ia32x64", "memory2", "memory", "memory-validation-bits",      \
		"nvidia", "nvidia_cmet_info", "nvidia_event_all_types",        \
		"nvidia_event_gpu_init", "nvidia_event_gpu_uce_ecc", "pcibus", \
		"pcidev", "pcie", "unknown"
